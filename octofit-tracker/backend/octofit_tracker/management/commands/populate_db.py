...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Tworzenie treningów
        Workout.objects.create(name='Full Body', description='Full body workout', duration=45)
        Workout.objects.create(name='Cardio', description='Cardio session', duration=30)
